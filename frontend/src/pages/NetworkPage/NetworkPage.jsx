...
const NetworkPage = () => {
	...
	const { data: connectionRequests, isError: isRequestsError } = useQuery({
        ...
        queryFn: async () => {
            try {
                ...
                toast.error(error.response?.data?.message || "Failed to fetch connection requests");
                throw error;
            }
        },
    ...
    const { data: connections, isError: isConnectionsError } = useQuery({
